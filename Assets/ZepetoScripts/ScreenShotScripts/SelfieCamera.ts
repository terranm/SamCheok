...
export default class SelfieCamera extends ZepetoScriptBehaviour {
    ...
    private CameraMovement() {
        ...
        ZepetoPlayers.instance.LocalPlayer.zepetoCamera.cameraParent.LookAt(this.transform);
        ZepetoPlayers.instance.LocalPlayer.zepetoCamera.cameraParent.eulerAngles = new Vector3(0, this.currentTarget.eulerAngles.y + 180, 0);
    }
